...
import controlador.ControladorCrearOrden;
...
public class VistaCrearOP extends javax.swing.JFrame {
    ...
    public void setControlador(ControladorCrearOrden control){
    ...
    public void cargarDatosLinea(ArrayList<Integer> linea, ArrayList <String>color,ArrayList <String>modelo, int numeroOp){
